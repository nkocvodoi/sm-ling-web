...
class ShowMoreExplainItem {
  ...
  ShowMoreModel createToolTips(String imageSrc, String title, String description, BuildContext context) {
    return ShowMoreModel(
      context,
      child: Container(
        child: ListTile(
          title: Text(title,
  ...
  ShowMoreModel createToolTipForText(String text, BuildContext context) {
    return ShowMoreModel(
      context,
      child: Container(
      ...
      backgroundColor: Color(0xFF48CEE0),
    );
  }
}
            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: Container(
                    ...
                    width: _popupWidth,
                    height: _popupHeight,
                    decoration: BoxDecoration(color: _backgroundColor, borderRadius: _borderRadius, boxShadow: [
                      BoxShadow(
