...
class LessonScreen extends StatefulWidget {
  ...
  LessonScreen({Key key, this.userLesson, this.userLevel, this.id}) : super(key: key);
...
class _LessonScreenState extends State<LessonScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: LessonInfoService().loadLessonInfo(
            bookID: saveCurrentBookId, lesson: widget.userLesson, level: widget.userLevel, unitID: widget.id),
          ...
          if (snapshot.hasData) {
            ...
            if (questions.isNotEmpty) {
              return Scaffold(
                  ...
                  body: Consumer3<LessonModel, MatchPairModel, SortWordsModel>(
                      builder: (_, lessonModel, matchPairModel, sortWordsModel, __) {
                    return WillPopScope(
                        onWillPop: () async {
                          ...
                          SizedBox(
                              ...
                              child: SingleChildScrollView(
                                ...
                                children: [
                                  ...
                                  QuestionCommon(
                                    question:
                                        Application.lessonInfo.lesson.questions[lessonModel.focusWordIndex as int],
                                  ),
                          ...
                          Positioned(
                              ...
                              child: lessonModel.hasCheckedAnswer != 0
                                  ? Container(
                                      ...
                                      height: handleHeight(textLength: lessonModel.handleAnswerWhenWrong().length),
                                      decoration: BoxDecoration(
                                      ...
                                      child: Column(children: [
                                        ...
                                        Expanded(child: SizedBox()),
                                        CustomButton(
                                            deactivate: lessonModel.onSubmitted as bool,
                                            elevation: 6,
                                        ...
                                        CustomButton(
                                            ...
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w700,
                                                  fontSize: TextSize.fontSize18,
                                                  color: !lessonModel.hasPicked(context: context)
                                                      ? AppColor.submitButtonText
                                                      : Colors.white),
                                            ),
                                            radius: 90,
                                            height: SizeConfig.safeBlockHorizontal * 13,
                                            width: SizeConfig.safeBlockHorizontal * 90,
                                            backgroundColor: lessonModel.hasPicked(context: context)
                                                ? AppColor.correctButtonBackground
                                                : AppColor.mainThemes,
                                            shadowColor: lessonModel.hasPicked(context: context)
                                                ? AppColor.correctButtonShadow
                                                : AppColor.mainThemesFocus,
                                            onPressed: () {
                                              lessonModel.handleTypeAnswer();
                                              lessonModel.checkRightAnswer(
          ...
          reportDialog(
              ...
              Application.lessonInfo.lesson.questions[focusWordIndex].type == "word"
                  ? Application.lessonInfo
                      .findWord(Application.lessonInfo.lesson.questions[focusWordIndex].focusWord)
                      .content
                  : Application.lessonInfo
                      .findSentence(Application.lessonInfo.lesson.questions[focusWordIndex].focusSentence)
                      .enText,
              Application.lessonInfo.lesson.questions[focusWordIndex].type == "word"
                  ? Application.lessonInfo
                      .findWord(Application.lessonInfo.lesson.questions[focusWordIndex].focusWord)
