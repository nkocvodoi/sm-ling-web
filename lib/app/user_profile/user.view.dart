      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                relativeApp(appIcon: 'assets/icon.png', name: 'Từ vựng tiếng Anh - Sách Mềm', top: 0, bottom: 15),
                relativeApp(appIcon: 'assets/icon.png', name: 'Từ vựng tiếng Anh - Sách Mềm', top: 0, bottom: 15),
                relativeApp(appIcon: 'assets/icon.png', name: 'Từ vựng tiếng Anh - Sách Mềm', top: 0, bottom: 0)
              ],
            ),
          )
        ],
...
Widget achievement({String image, String userNumber, String message}) {
  return Container(
    ...
    decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color(0xFF97CFF5), // darker color
          ),
          BoxShadow(
          ...
          child: RichText(
            ...
            text: TextSpan(
              ...
              children: [
                TextSpan(
                    text:
                        (userNumber.length * SizeConfig.blockSizeHorizontal * 5 +
                        message.length * SizeConfig.blockSizeHorizontal * 3 > SizeConfig.blockSizeHorizontal * 25)
                            ? '\n'
                            : '',
                    style: TextStyle(
