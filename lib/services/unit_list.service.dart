...
class UnitListService {
  ...
  Future<UnitList> loadUnitList(String id) async {
    ...
    Application.sharePreference.putString("loadUnitList", "/api/book/$id/units");
    try {
      if (response.statusCode == 200) {
        Application.currentBook = Application.bookList.books.elementAt(Application.bookList.books.indexWhere((element) => element.id == id));
